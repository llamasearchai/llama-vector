# Contributing to Llama Vector

Thank you for your interest in contributing to Llama Vector! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Vector:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-vector.git
   cd llama-vector
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-vector.git
   ```
...
By contributing to Llama Vector, you agree that your contributions will be licensed under the project's MIT License.
